            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="list.php">Lists</a>
                    </div>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <?php echo $_SESSION['usersLogin']['name'] ?>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php echo $book['categories_name']?></td>
                        ...
                        <td>
                            <button class="btn btn-primary"><a href="update.php" style="color: white">Update</a></button>
                            <button class="btn btn-danger">
                                <a href="../action/delete-book.php?id=<?php echo $book['products_id']?>" style="color: white">Delete</a></button>
                        </td>
                    </tr>
                    <?php
                        endforeach;
